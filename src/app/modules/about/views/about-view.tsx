    ...
    return (
        <section className="h-screen w-full flex items-center overflow-hidden">
            ...
            <div className="relative flex w-full h-full">
                    ...
                    <div className="md:w-[100px]">
                        <div
                            className="absolute hidden sm:block 
                                ...
                                md:w-[min(60vw,500px)] md:h-[min(60vw,500px)] md:translate-x-16 md:mt-0
                                sm:w-[min(70vw,400px)] sm:h-[min(70vw,400px)] sm:mt-12
                                w-[min(90vw,400px)] h-[min(90vw,400px)] mt-60
                    ...
                    <div className="flex flex-col w-full bg-green-300">
                        <Image
                            ...
                            className="hidden sm:block
                                lg:w-[500px] lg:h-[500px] lg:-translate-x-16 lg:bottom-0
                                md:w-[590px] md:h-[480px] md:-translate-x-44 md:absolute 
                                sm:w-[390px] sm:h-[380px] sm:-translate-x-36 sm:bottom-0
                ...
                <aside className="w-1/2 min-h-screen  flex flex-col justify-center items-center py-8">
                    {/* Título */}
